...
const Hero = () => {
  return (
    <div style={{backgroundImage:`url(${herobg})`}} className='flex flex-col items-center text-white h-[100vh] bg-no-repeat bg-cover bg-center justify-center px-4 text-center'>
